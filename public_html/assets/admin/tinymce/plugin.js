...
(function () {
  ...
  function bootstrap4GridPlugin(editor, url) {
    editor.contentCSS.push(window.location.origin + '/assets/admin/tinymce/bootstrapgrid-style.css');

    editor.ui.registry.addToggleButton('bootstrap4grid', {
      text: 'GRIDS',
      tooltip: 'Bootstrap Grid System',
    ...
    function Tinymce_bs4_grid() {
      var dialogueTitle = 'Insert Bootstrap Grids';
      var columnValue = '12';
      var screenSize = '-md';
      ...
      if (editMode) {
        ...
        dialogueTitle = 'Update/Remove Bootstrap Grids';
      }
